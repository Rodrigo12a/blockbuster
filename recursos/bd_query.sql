...
CREATE TABLE generos (
    ...
    descripcion_genero VARCHAR(255) NULL DEFAULT 'Sin descripción...'
)ENGINE=InnoDB;
...
CREATE TABLE streaming (
    ...
    trailer_streaming VARCHAR(70) NOT NULL COMMENT 'trailer_streaming.mp4',
    ...
    sinopsis_streaming VARCHAR(255) DEFAULT 'Sin descripción por el momento' COMMENT '',
...
INSERT INTO streaming (id_streaming, estatus_streaming, nombre_streaming, fecha_lanzamiento_streaming, duracion_streaming, caratula_streaming, trailer_streaming, clasificacion_streaming, sinopsis_streaming, fecha_estreno_streaming, id_genero) VALUES
...
INSERT INTO streaming (id_streaming, estatus_streaming, nombre_streaming, fecha_lanzamiento_streaming, temporadas_streaming, caratula_streaming, trailer_streaming, clasificacion_streaming, sinopsis_streaming, fecha_estreno_streaming, id_genero) VALUES
    (NULL, 1, 'La casa de Papel', '2017-08-12', 5, 'caratula_casa_de_papel.png', 'trailer_casa_de_papel.mp4', 'B15', 'Ocho ladrones toman rehenes en la Fábrica Nacional de Moneda y Timbre de España, mientras el líder de la banda manipula a la policía para cumplir con su plan', '2025-03-16', 7);
...
CREATE TABLE videos (
    ...
    video VARCHAR(70) NOT NULL COMMENT 'nombre_video.mp4',
    ...
    capitulo_temporada TINYINT(1) NULL COMMENT 'Capitulo 1, Episodio 1',
...
CREATE TABLE pagos (
    ...
    fecha_registro_pago DATE NOT NULL,
    estatus_pago TINYINT(1) NULL DEFAULT -1 COMMENT '-1: Rechazado, 0: Pendiente, 1: Aceptado',
    monto_pago DECIMAL(10,2) NOT NULL,
    tarjeta_pago VARCHAR(32) NOT NULL COMMENT 'Número de tarjeta enmascarado',
    id_usuario INT(11) NOT NULL,
    id_plan INT(3) NOT NULL,
    FOREIGN KEY(id_usuario) REFERENCES usuarios (id_usuario) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY(id_plan) REFERENCES planes (id_plan) ON DELETE CASCADE ON UPDATE CASCADE
